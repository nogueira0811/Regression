---
title: "Regression Analysis of Mortality Rates across U.S. Cities: Final Report"
...
In their 1973 study, McDonald and Schwing introduced a dataset to examine the correlation between total mortality and various influencing factors, such as climate, socioeconomic conditions, and pollution, across 60 U.S. cities in 1960. This project performs regression analysis with total age-adjusted mortality from all causes as the response variable. The analysis identifies key predictors of mortality rates and explores how these factors vary across different cities.

Below are the fifteen predictor variables selected for the study:
